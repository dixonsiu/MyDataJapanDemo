...
if (_.isUndefined(sessionStorage.cellname) || _.isNull(sessionStorage.cellname)) {
  location.href = "login.html?mode=demo&target=itou";
}

function getProfileFromSession() {
  if (_.isUndefined(sessionStorage.myProfile) || _.isNull(sessionStorage.myProfile)) {
    location.href = "login.html?mode=demo&target=itou";
  }
  return JSON.parse(sessionStorage.myProfile);
};

function getSortedEventsFromSession() {
  if (_.isUndefined(sessionStorage.sortedEvents) || _.isNull(sessionStorage.sortedEvents)) {
    location.href = "login.html?mode=demo&target=itou";
  }
  return JSON.parse(sessionStorage.sortedEvents);
}
